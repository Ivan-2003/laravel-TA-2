        ...
        <div class="flex-center position-ref full-height">
            @if (Route::has('login'))
                <div class="top-right links">
                    ...
                    @else
                        <a href="{{ route('customer.loginform') }}"><button class="btn btn-secondary"><b>Sign In</b></button></a>

                        @if (Route::has('register'))
                            <a href="{{ route('customer.registerform') }}"><button class="btn btn-secondary"><b>Sign Up</b></button></a>
                        @endif
                    @endauth
                </div>
            @endif
